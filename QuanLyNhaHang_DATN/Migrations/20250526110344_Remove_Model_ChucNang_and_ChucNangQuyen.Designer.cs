...
namespace QuanLyNhaHang_DATN.Migrations
{
    ...
    [Migration("20250526110344_Remove_Model_ChucNang_and_ChucNangQuyen")]
    partial class Remove_Model_ChucNang_and_ChucNangQuyen
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuanLyNhaHang_DATN.Models.BanSchedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("BanSchedule", (string)null);
                });
            ...
            modelBuilder.Entity("QuanLyNhaHang_DATN.Models.DatBan_Ban", b =>
                {
                    b.Property<int>("DatBanId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("DatBanId", "BanId");

                    b.HasIndex("BanId");

                    b.ToTable("DatBan_Ban", (string)null);
                });
            ...
            modelBuilder.Entity("QuanLyNhaHang_DATN.Models.HoaDon", b =>
                {
                    ...
                    b.Property<decimal>("TongTienGoiMon")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("QuanLyNhaHang_DATN.Models.BanSchedule", b =>
                {
                    b.HasOne("QuanLyNhaHang_DATN.Models.Ban", "Ban")
                        .WithMany()
                        .HasForeignKey("BanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
